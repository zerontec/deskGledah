...
const CREATE_PAYMENT_CUSTOMER_SUCCESS ='CREATE_PAYMENT_SUCCESS'
const CREATE_PAYMENT_CUSTOMER='CREATE_PAYMENT_CUSTOMER'
const UPDATE_PAYMENT_CUSTOMER= 'UPDATE_PAYMENT_CUSTOMER'
const GET_ALL_PAYMENT_CUSTOMER='GET_ALL_PAYMENT_CUSTOMER'
...
export const createPaymentCustomer = (data) => async (dispatch) => {
  try {
...
// eslint-disable-next-line func-names
  ...
  export const updatePayment = (id, data) => async (dispatch) => {
    try {
      const resp = await axios.put(`${API_URL_D}api/loanCustomer/update-payment/${id}`, data,{ headers: authHeader() });
  
      dispatch({
        type: UPDATE_PAYMENT_CUSTOMER,
        payload: resp.data,
      });
...
export const getAllPaymentCustomer=() => async (dispatch) => {
...
export default function paymentCustomerReducer(state = initialState, action) {
  switch (action.type) {



    case GET_ALL_PAYMENT_CUSTOMER:
        return {
          ...state,
          paymentsCustomer: action.payload,
        };
    ...
    case CREATE_PAYMENT_CUSTOMER_SUCCESS:
      return {
        ...state,
