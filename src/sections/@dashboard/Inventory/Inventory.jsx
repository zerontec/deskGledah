...
const Inventory = () => {
  ...
  const validateForm = () => {
    const { barcode, name, description, price, quantity, costo } = formInfo;
    setIsFormValid(
      barcode.trim() !== '' &&
        name.trim() !== '' &&
        description.trim() !== '' &&
  ...
  function validate(formInfo) {
    const errors = {};
    formInfo.barcode ? (errors.barcode = '') : (errors.barcode = 'Ingrese un barcode');
    formInfo.name ? (errors.name = '') : (errors.name = 'Ingrese Nombre de Producto');
    formInfo.description ? (errors.description = '') : (errors.description = 'Ingrese una Descripcion');

    formInfo.price ? (errors.price = '') : (errors.price = 'Ingrese un Precio');

    formInfo.quantity ? (errors.quantity = '') : (errors.quantity = 'Ingrese una cantidad');

    formInfo.costo ? (errors.costo = '') : (errors.costo = 'Ingrese costo');
