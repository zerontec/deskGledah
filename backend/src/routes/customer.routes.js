...
const { getCustomerDebt } = require('../controller/loanCustomer.controller');
...
router.get('/customer/:customerId/debt',authJwt.verifyToken, authJwt.isAdmin, getCustomerDebt);
