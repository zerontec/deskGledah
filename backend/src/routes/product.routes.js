...
const {getAllQuantityProduct, getAllQuantity,serachProductByQuery,updateProduct,moveProductToStoreA,createProduct, updateProductQuantity, getProducts, deleteProductP, deleteMultipleProducts, getProductStat, crearCargaMasivaProductos, obtenerEstadisticasProducto, obtenerCantidadTotalMercancia, obtenerInventarioInicialYFinal } = require('../controller/product.controller');
...
router.get('/quantity', obtenerCantidadTotalMercancia)
router.get('/cierre-mes/:fechaInicial/:fechaFinal',obtenerInventarioInicialYFinal)
