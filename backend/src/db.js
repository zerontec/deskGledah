...
PaymentCuenta.belongsTo(AccountsReceivable, {foreignKey: 'ventaId'})

PaymentClient.belongsTo(LoanClient,{ foreignKey: 'loanId' });
LoanClient.hasMany(PaymentClient, { foreignKey: 'loanId' });
